...
const OrganizerDashboard = () => {
  ...
  const [activeView, setActiveView] = useState<"dashboard" | "create" | "my-tournaments" | "players" | "settings" | "manage-tournament">(initialView);
                ...
                <div className="od__chartWrap">
                  {stats?.trendData ? (
                    (() => {
                      ...
                      const isAllZero = stats.trendData.every(v => v.value === 0);
                      
                      if (isAllZero) {
                        return (
                          <div style={{ textAlign: 'center', opacity: 0.5 }}>
                            <TrendingUp size={48} style={{ marginBottom: '12px' }} />
                            <p>No registration data for the last 6 months</p>
                          </div>
                        );
                      }
